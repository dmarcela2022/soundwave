...
function Discover() {
  return (
    <section className="Discover" style={{display:"flex", justifyContent:"center",alignItems:"center"}}>
        <Box>
          ...
          <p>By joing you can benefit by listening to the latest album released.</p>
        </Box>
        <Box><img className="imgCover" src={imgCover} alt="coverimg1" /></Box>
    </section>
  );
}
